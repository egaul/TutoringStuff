...
public class MyAssets {
	...
	public static void main(String[] args) {
		...
		InvestmentAccount paulWallet = new InvestmentAccount("Paul", "112-12-1111", "104", "813");

		do {
			menuprompt();
			choice = scan.nextInt();
			while(choice < 1 || choice > 7) {//changed if branch to while loop
			...
			case 2:
				...
				//paulWallet).depositMoney(scan.nextDouble());
				((CheckingAccount) paulWallet).depositMoney(scan.nextDouble());
				break;
			case 3:
				...
				break;
			case 4: 
				System.out.println("Checking account balance: $"+String.format("%,.2f", paulWallet.getDollars()));//added pretty string formatting
				break;
			case 5:
				System.out.println("Investment account balance: $"+String.format("%,.2f", paulWallet.getTotalInvestments()));//added pretty string formatting
				break;
			case 6:
				System.out.println("\n"+ paulWallet);
				break;
